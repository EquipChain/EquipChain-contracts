/**
 * TypeScript bindings for Equipchain Smart Contract
 * These types are auto-generated from the Soroban contract definitions
 * 
 * @fileoverview Type-safe interfaces for interacting with the Equipchain contract
 * @version 1.0.0
 */
